...
from . import (JonesSolver, build_antenna_graph, bfs_order, solve_jax_bfgs)
...
class ParallelDelaySolver(JonesSolver):
    ...
    def solve(self, vis_obs, vis_model, ant1, ant2, freqs, n_ant,
        ...
        wall = _time.time() - t0
        return {
            "jones": J_mean, "converged": conv, "n_iter": n_iter,
    ...
    def _solve_jax(self, delay_init, vis_obs, vis_model,
        ...
        try:
            ...
            return solve_jax_bfgs(cost_fn_jax, delay_init.flatten(),
